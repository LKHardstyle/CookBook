...
{   
    public class FoodManagerCache
    {
        ...
        public FoodManagerCache(IIngredientsRepository ingredientsRepository, IRecipesRepository recipesRepository, IRecipeIngriendtsRepository recipeIngriendtsRepository) 
        {
...
//Bad SoC - Service should not manipulate UI elements directly, UI Form should do that
        ...
        public async Task RefreshData()
        {
            ...
            _recipes = await _recipesRepository.GetAllRecipe();
